...
*  MattkeysMeUpdater
*
*  this class will connect with and download updates from mattkeys.me
**
*/

class MattkeysMeUpdater
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'   =>  '',
			'remote'    =>  'http://mattkeys.me/updates/wp_nav_plus_A8DF5M4.php?check=info&referrer=' . $site_url,
